...
""")
st.markdown(
    "<span style='color: #FF9561;'>Your spreadsheet should include these columns in the exact following sequence: Brand, Item number, Name, ID with exact titles to each of these columns as mentioned.</span>",
